...
jQuery.fn.pagination = function(a, b) {
    ...
    return this.each(function() {
        ...
        function g() {
            ...
            var m = h > k ? Math.max(Math.min(h - k, j), 0) : 0;
            var i = h > k ? Math.min(h + k, l) : Math.min(b.num_display_entries, l);
            return [m, i]
        }
        function e(j, i) {
            h = j;
        ...
        function c() {
            ...
            var n = function(i, q) {
                ...
                q = jQuery.extend({
                    ...
                    q || {});
                if (i == h) {
                    var r = $("<span class='current'>" + (q.text) + "</span>")
                } else {
                    var r = $("<a>" + (q.text) + "</a>").bind("click", p(i)).attr("href", b.link_to.replace(/__id__/, i))
                }
                if (q.classes) {
            ...
            if (b.first_text && b.first_show_always) {
                n(0, {
                    text: b.first_text,
                    classes: "first"
                })
            ...
            if (b.last_text && b.last_show_always) {
                n(o, {
                    text: b.last_text,
                    classes: "last"
                })
            }
            if (a > 10 && b.is_show_jump) {
                jQuery('<span class=\"go\"><input type=\"text\" class=\"input_txt song\"/></span>').keydown(function(i) {
                    if (i.keyCode == 13) {
...
(function(a) {
    a.fn.lazyload = function(b) {
        ...
        if ("scroll" == d.event) {
            var c = function(h) {
                ...
                e = a(g);
                if (e.length == 0) {
                    a(d.container).unbind("scroll", c)
                }
            };
            a(d.container).bind("scroll", c)
        }
        this.each(function(g) {
            ...
            if (a.abovethetop(f, d) || a.leftofbegin(f, d) || a.belowthefold(f, d) || a.rightoffold(f, d)) {
                f.loaded = false
            } else {
                a(f).trigger("appear");
                f.loaded = true
    ...
    a.fn.imagelazyload = function(b) {
        var c = {
            load: function(d, e) {
                a("<img />").bind("load",
                    function() {
                        a(d).hide().attr("src", a(d).attr("xsrc"))[e.effect](e.effectspeed);
                        d.loaded = true
                    }).attr("src", a(d).attr("xsrc"))
            }
        };
        if (b) {
            a.extend(c, b)
